...
<head>
    ...
    <title>Proactive Content Caching - Sender Login</title>
...
if(request.getParameter("msg")!=null){%>
   ...
   <div class="container mt-3">
       <div class="alert alert-success alert-dismissible fade show" role="alert">
           <i class="fas fa-check-circle me-2"></i>Sender Registration Successful!
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <h1><i class="fas fa-sign-in-alt me-3"></i>Sender Login</h1>
                <p>Access your account to upload and manage content in the proactive caching system</p>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="card fade-in">
                        <div class="card-header">
                            <h5><i class="fas fa-user-circle me-2"></i>Sender Login</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobilesource_reg.jsp" class="btn btn-success">
