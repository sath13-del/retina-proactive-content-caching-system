...
<%
    ...
    PreparedStatement ps=con.prepareStatement("insert into edgeserver_files values(?,?,?,?,?,?)");

    ps.setString(1,rs.getString("filename"));
    ps.setString(2,email);
    ps.setString(3,rs.getString("file"));  
    ...
    response.sendRedirect("mobilesource_send.jsp?m1");
    }
    else 
    {
    response.sendRedirect("mobilesource_send.jsp?m2=LoginFail");
    }
    }
    catch(Exception e)
    {
   response.sendRedirect("mobilesource_send.jsp?m3=LoginFail");
    }
%>