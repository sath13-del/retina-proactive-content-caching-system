...
<head>
    ...
    <title>Proactive Content Caching - Cloud Server Requests</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="cloud_view_req.jsp">View Requests</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <h1><i class="fas fa-list me-3"></i>Cloud Server Requests</h1>
                <p>Manage and process file requests from Receivers in the cloud server</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="card fade-in">
                <div class="card-header">
                    <h5><i class="fas fa-envelope me-2"></i>Pending File Requests</h5>
                </div>
                <div class="card-body">
    <style>
        th{
	...
	while(rs.next()){
            %><tr>
                ...
                <td><%=rs.getString("md")%></td>
                        ...
                        <td><a href="cloud_view_reqact.jsp?filename=<%=rs.getString("filename")%>&ms=<%=rs.getString("ms")%>&md=<%=rs.getString("md")%>" class="btn btn-success btn-sm"><i class="fas fa-check me-1"></i>Process</a></td>
